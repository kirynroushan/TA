			...
			<div class='loader'></div>
				<div class='wrapper'>
							...
							<ul class=' sidebar-menu tree data-widget='tree' >
								...
								if($pengawas['level']=='admin') {
									...
									<li class=' treeview'>
										...
										<li class='treeview'><a href='?pg=siswa'><i class='fa  fa-group'></i> <span>Peserta Ujian</span></a></li>
										...
										<li class='treeview'>
										<a href='#'><i class='glyphicon glyphicon-print'></i><span> Cetak </span><span class='pull-right-container'> <i class='glyphicon glyphicon-plus pull-right'></i> </span></a>
										<ul class='treeview-menu'>
					...
					<section class='content-header'>
						...
						<tr>
						<td rowspan='4' width='120' align='center'><img src='$homeurl/foto/tut.jpg' width='80'></td>
										...
										<div class='col-md-12'>
													...
													<div class='box box-solid'>
														<div class='box-header with-border '>
															...
															if($pengawas['level']=='admin') {
															echo "
																<button id='buatberita' class='btn btn-sm btn-primary'><i class='fa fa-refresh'></i> Generate</button>
													...
													while($berita= mysql_fetch_array($beritaQ)) {
														...
														echo "
															...
															if(isset($_POST['print'])) {
																...
																$exec = mysql_query("UPDATE berita SET ikut='$hadir',susulan='$tidakhadir',mulai='$mulai',selesai='$selesai',nama_pengawas='$pengawas',nip_pengawas='$nippengawas',
															...
															<div class='form-group'>
																...
																<select name='nosusulan[]' class='form-control select2' multiple='multiple' style='width:100%' required='true'>
